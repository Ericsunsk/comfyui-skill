...
<Card title="使用管理器安装节点" icon="icon" href="/zh-CN/manager/legacy-ui#使用管理器安装节点">
  查看如何使用管理器进行节点安装
</Card>
