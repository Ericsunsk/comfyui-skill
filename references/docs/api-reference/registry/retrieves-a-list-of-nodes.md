...
````yaml https://api.comfy.org/openapi get /nodes
openapi: 3.0.2
info:
  title: Comfy API
  version: '1.0'
      ...
      parameters:
        ...
        - description: Number of nodes to return per page
          ...
          schema:
            type: boolean
        - description: >-
            Retrieve nodes created or updated after this timestamp (ISO 8601
            format)
          in: query
          name: timestamp
          schema:
            ...
            type: string
        - description: >-
            Whether to fetch fresh result from database or use cached one if
            false
          in: query
          name: latest
          schema:
            type: boolean
        - description: >-
            Database column to use as ascending ordering. Add `;desc` as suffix
            on each column for descending sort
          in: query
          name: sort
          schema:
            items:
